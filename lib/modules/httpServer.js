...
(function() {
  module.exports = function() {
    var app, bodyParser, express, port, swig, weblogger;
    express = require('express');
    swig = require('swig');
    bodyParser = require('body-parser');
    if (global.AnonyPages.enableWebLogger) {
    ...
    app.listen(port, function() {
      if (global.AnonyPages.enableWebLogger) {
        return console.log("AnonyPages web server listening on port " + port);
      }
    });
    ...
    return app.use(function(req, res, next) {
      return global.AnonyPages.functions.notFound(req, res);
    });
  };
